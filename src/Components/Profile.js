...
const Profile = () => {
   ...
   useEffect(() => {
        const revealConfigs = [
            { selector: ".reveal-Left", origin: "left" },
            { selector: ".reveal-Bottom", origin: "bottom" }
        ];
        ...
        <div className="grid grid-rows-2 mt-3 md:grid-cols-2 md:grid-rows-none items-center">
            ...
            <section className="personal-info">
                <div className="flex flex-wrap justify-center place-content-center mx-4">
                    <h1 className="reveal-Left font-bold font-Montserrat text-lg text-white animate-bounce sm:text-2xl ">
                        Hello, I'm Anthony Irudhaya Aakash A
                    </h1>
                    <p className="reveal-Left font-Montserrat text-lg text-secondary text-center pt-2">
            ...
            <section className="profile-picture">
                <div className="reveal-Bottom flex justify-center place-content-center my-4">
                    <img
